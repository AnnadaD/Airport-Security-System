...
public class updateflightstatus extends HttpServlet {
	 ...
	 try {
		 Class.forName("com.mysql.cj.jdbc.Driver");
		  conn=DriverManager.getConnection("jdbc:mysql://localhost/Airport_Security","root","sakshi123");
			  ...
			  pstmt=conn.prepareStatement("UPDATE Flights SET Current_status=? WHERE FlightNo=? and DOF=?");
				 pstmt.setString(1, Current_status);
				 pstmt.setString(2, FlightNo);
				 pstmt.setString(3, DOF);
