...
public class insertblacklist extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	 ...
	 String Country=request.getParameter("PName");
	 String DOBlack=request.getParameter("DOBlack");
	 ...
	 try {
		 Class.forName("com.mysql.cj.jdbc.Driver");
		  conn=DriverManager.getConnection("jdbc:mysql://localhost/Airport_Security","root","sakshi123");
			  ...
			  pstmt=conn.prepareStatement("insert into Blacklist(Aadhaar,Passport,Country,DOBlack) values(?,?,?,?) ");
				 pstmt.setString(1, Aadhaar);
				 pstmt.setString(2, Passport);
				 pstmt.setString(3, Country);
				 pstmt.setString(4, DOBlack);
