	 ...
	 try {
		 ...
		 Class.forName("com.mysql.cj.jdbc.Driver");
		  conn=DriverManager.getConnection("jdbc:mysql://localhost/Airport_Security","root","sakshi123");
		   ...
		   pstmt = conn.prepareStatement("select * from Flights");
		   ResultSet rs=pstmt.executeQuery();
		  
		   PrintWriter out=response.getWriter();
		   out.println("<html><body><table><tr><td>FlightNo</td><td>DOF</td><td>Depart_time</td><td>Arrival_time</td><td>Depart_gate</td><td>Current_status</td><td>Baggage_belt</td></tr>");
  while(rs.next()) {
